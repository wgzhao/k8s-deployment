...
The StatefulSet controller creates three Pods, and each Pod has a container with a [ZooKeeper](https://archive.apache.org/dist/zookeeper/stable/) server.
